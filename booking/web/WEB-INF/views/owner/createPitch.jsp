        ...
        <div class="col-lg-10 col-xl-9 mx-auto">
            <div class="card flex-row my-5 border-0 shadow rounded-3 overflow-hidden">
                <div class="card-body p-4 p-sm-5">
                    ...
                    <h5 class="card-title text-center mb-5 fw-light fs-5">Tạo sân mới</h5>
                    <form action="${pageContext.request.contextPath}/owner/goToLoadPictureCreate.do" method="post" class="needs-validation" novalidate>
                        ...
                        <div class="form-floating mb-3">
                            <textarea type="text" class="form-control" id="floatingInputUsername" placeholder="myusername" name="description" maxlength="500" required autofocus style="height: 200px">${p.pitchDescription}</textarea>
