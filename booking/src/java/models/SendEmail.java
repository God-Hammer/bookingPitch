...
public class SendEmail {
    ...
    public boolean sendEmail(User user, String code) {
        ...
        String fromEmail = "HostelManagementSE1633@gmail.com";
    ...
    public boolean sendEmailConfirmOwner(User user) {
        ...
        try {
            ...
            String message = "<!DOCTYPE html>\n"
                    ...
                    + "<body>\n"
                    + "    <h3 style=\"color: blue;\">Xin chào " + user.getFullName() + " !</h3>\n"
                    + "    <div>Admin đã xác nhận cho bạn trở thành chủ sân</div>\n"
                    + "    <div>Bây giờ bạn có thể đăng nhập với tư cách là chủ sân với tài khoản đã đăng ký</div>\n"
                    + "    <div>Thư này được tạo ra tự động.</div>\n"
                    + "    <div>Nếu bạn cần trợ giúp hoặc có câu hỏi, hãy gửi email đến minhkhoi11.04nhmk@gmail.com bất cứ lúc nào.</div>\n"
                    + "    <h3 style=\"color: blue;\">Trân trọng!</h3>\n"
                    + "\n"
    ...
    public boolean sendEmailDenyOwner(User user, String reason) {
        ...
        try {
            ...
            String message = "<!DOCTYPE html>\n"
                    ...
                    + "<body>\n"
                    + "    <h3 style=\"color: blue;\">Xin chào " + user.getFullName() + " !</h3>\n"
                    + "    <div>Admin đã từ chối cho bạn trở thành chủ sân</div>\n"
                    + "    <div>Lý do: " + reason +"</div>\n"
                    + "    <div>Thư này được tạo ra tự động.</div>\n"
                    + "    <div>Nếu bạn cần trợ giúp hoặc có câu hỏi, hãy gửi email đến minhkhoi11.04nhmk@gmail.com bất cứ lúc nào.</div>\n"
                    + "    <h3 style=\"color: blue;\">Trân trọng!</h3>\n"
    ...
    public boolean sendEmailDeleteUser(User user, String reason) {
        ...
        try {
            ...
            String message = "<!DOCTYPE html>\n"
                    ...
                    + "<body>\n"
                    + "    <h3 style=\"color: blue;\">Xin chào " + user.getFullName() + " !</h3>\n"
                    + "    <div>Admin đã xóa tài khoản sử dụng của bạn</div>\n"
                    + "    <div>Lý do: " + reason +"</div>\n"
                    + "    <div>Thư này được tạo ra tự động.</div>\n"
                    + "    <div>Nếu bạn cần trợ giúp hoặc có câu hỏi, hãy gửi email đến minhkhoi11.04nhmk@gmail.com bất cứ lúc nào.</div>\n"
                    + "    <h3 style=\"color: blue;\">Trân trọng!</h3>\n"
