...
public class Pitch {
    ...
    public Pitch(String pitchID, String wardID, String districtID, String userID, String pitchName, String pitchAddress, int estimation, String pitchDescription, boolean pitchStatus) {
